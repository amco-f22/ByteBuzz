...
- 📝 Create blog posts with custom icons
- ✏️ Edit your existing posts
- 🗑️ Delete posts
- 💬 Comment on posts
- 🎨 Modern dark UI with glassmorphism and gradients
...
scp -r -i your-key.pem ./ByteBuzz ubuntu@<EC2_PUBLIC_IP>:~/ByteBuzz
```
